<?php
 ...
 $firstName=$_SESSION['first_name_owner'];
 $middleName=$_SESSION['middle_name_owner'];
 $lastName=$_SESSION['last_name_owner'];
 if($userprofile == true){
...
$userprofile = $_SESSION['user_name'];
    include("../connection.php");
   error_reporting(0);
   $query="SELECT * FROM uploadroomplot WHERE userName='$userprofile';";
...
<body>
        ...
        <div class="nav-bar">
            ...
            <div class="home-search-bar">
                ...
                <div class="home-mes-not">
                  ...
                  <a href=""><button class="nav-btn nav-btn-hover">Message</button></a>
                         ...
                         <span>
                            <p>
                                <?php
                                   session_start();
                                   include("../connection.php");
                                   echo $_SESSION['first_name_owner']," ",$_SESSION['middle_name_owner']," ",$_SESSION['last_name_owner'];
                                ?>
                            </p>
                         </span>
                        </div>
    ...
    <main>
        <div class="function_of_owner">
            <div class="upload_rooms">
                <a href="uploadRoom.php"><input  class="fow_btn" type="submit" value="Upload Rooms"></a>
            </div>
            <div class="rent_request">
                <button  class="fow_btn">Rent Request</button>
            </div>
            <div class="buy_request">
                <button  class="fow_btn">Buy Request</button>
            </div>
            <div class="call_request">
                 <button  class="fow_btn">Call Request</button>
            </div>
        </div>
        <style>
            .function_of_owner{
        ...
        <div class="owner_display_room_plots">
            ...
            <div class="odrp_address">
                User ID : <?php echo $row['userName']?>
                <br>
                <div class="odrp_owner_name"  style="font-size:20px;"><?php echo $firstName." ".$middleName." ".$lastName?> 
                <br> 
                Phone Number : <?php echo $row['phnumber']?>
                </div>
            </div>
